...
const variants = {
  ...
  image: "border-0 p-0 min-h-0 min-w-0 relative rounded-full",
  active: "border-2",
      ...
      <div
        ...
        {imageUrl ? (
          ...
          <div className="flex flex-col items-center justify-center text-xs text-gray-400">
            ...
            <div className="text-gray-400">Click or Drag&Drop to upload your server image</div>
            {/* Button 'Select' removed for now */}
            {/* <div className="mt-3">
              <Button
                type="button"
                disabled={disabled}>
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        "border border-gray-400 text-gray-400 shadow hover:bg-gray-100 hover:text-gray-500 dark:border-gray-600 dark:text-black dark:hover:bg-gray-700 dark:hover:text-white",
        // size
